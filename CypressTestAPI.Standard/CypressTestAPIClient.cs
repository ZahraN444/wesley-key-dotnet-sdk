...
namespace CypressTestAPI.Standard
{
    ...
    public sealed class CypressTestAPIClient : IConfiguration
    {
        ...
        /// </summary>
        /// <returns> CypressTestAPIClient.</returns>
        public static CypressTestAPIClient FromConfiguration(IConfigurationSection configuration) =>
        ...
        {
            private Environment _environment = CypressTestAPI.Standard.Environment.Production;
            private string _defaultHost = "www.example.com";
            ...
            {
                _defaultHost = defaultHost ?? throw new ArgumentNullException(nameof(defaultHost));
                return this;
            }
        ...
        public class CypressTestAPIClientOptions
        {
