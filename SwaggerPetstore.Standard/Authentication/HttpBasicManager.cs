...
namespace SwaggerPetstore.Standard.Authentication
{
    ...
    public sealed class HttpBasicModel
    {
        ...
        internal static HttpBasicModel FromOptions(HttpBasicModelOptions options)
        {
            var builder = new Builder(options.Username, options.Passwprd);
            return builder.Build();
        }
    }

    public class HttpBasicModelOptions
    {
