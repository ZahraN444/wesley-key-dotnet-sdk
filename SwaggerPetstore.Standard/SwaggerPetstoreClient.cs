...
namespace SwaggerPetstore.Standard
{
    ...
    public sealed class SwaggerPetstoreClient : IConfiguration
    {
        ...
        /// </summary>
        /// <returns> SwaggerPetstoreClient.</returns>
        public static SwaggerPetstoreClient FromConfiguration(IConfigurationSection configuration) =>
        ...
        {
            private string _testHeader = "TestHeaderDefaultValue";
            private Environment _environment = SwaggerPetstore.Standard.Environment.Production;
            private ApiKeyModel _apiKeyModel = new ApiKeyModel();
            private HttpBasicModel _httpBasicModel = new HttpBasicModel();
            ...
            {
                _httpBasicModel = httpBasicModel ??
            ...
            {
                _testHeader = testHeader ?? throw new ArgumentNullException(nameof(testHeader));
                return this;
            }
            ...
            public SwaggerPetstoreClient Build()
            {
                ...
                if (_httpBasicModel.Username == null || _httpBasicModel.Passwprd == null)
                {
                    _httpBasicModel = null;
                }
            ...
            {
                var builder = new Builder();
                var options = config.Get<SwaggerPetstoreClientOptions>();
                if (options == null) return builder;
                if (options.TestHeader != null)
                    builder.TestHeader(options.TestHeader);
                ...
                if (options.HttpBasicCredentials != null)
                    builder.HttpBasicCredentials(HttpBasicModel.FromOptions(options.HttpBasicCredentials));
        ...
        public class SwaggerPetstoreClientOptions
        {
            public string TestHeader { get; set; }
            public Environment? Environment { get; set; }
            public ApiKeyModelOptions ApiKeyCredentials { get; set; }
            public HttpBasicModelOptions HttpBasicCredentials { get; set; }
